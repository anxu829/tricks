...
sudo nvidia-docker run --name detectron_tutorial -it  -p 8999:8899 anxu5829/detectron:c2-cuda9-cudnn7 /bin/bash -c "jupyter lab --port 8899 --ip 0.0.0.0 --allow-root"
